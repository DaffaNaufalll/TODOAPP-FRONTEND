...
const MyTaskComponent = ({ refreshFlag }) => {
  ...
  return (
    <div>
      ...
      {!loading && tasks.length === 0 && (
        <p className="text-green-900">No tasks available.</p>
      )}
      ...
      {!loading &&
        tasks.map((task) => (
          <div
            key={task.id}
            className="flex flex-col gap-2 mt-2 p-4 text-white bg-green-700 rounded-md shadow-md"
          >
